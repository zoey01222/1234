...
def home_page():
    ...
    left_col.markdown(
        ...
        <a href="mira0122@163.com">mira0122@163.com</a></p>   
        """,
        unsafe_allow_html=True # markdown section 的时候要加这个
    )
...
# 如何加邮件链接：<a href=  </a>     
    ...
    image = Image.open("./util/data/image.png")
    ...
    # 一个* 可以将内容斜体   ###和#的About me的大小是不一样的
